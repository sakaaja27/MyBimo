...
//                startActivity(intent);
    ...
    private class OtpTextWatcher implements TextWatcher {
        private final EditText sebelumBox;
        private final EditText setelahBox;

        public OtpTextWatcher(EditText sebelumBox, EditText setelahBox) {
            this.sebelumBox = sebelumBox;
            this.setelahBox = setelahBox;
        }
